...
public class Edit_fournisseur extends JFrame {
	...
	protected static JTextField textField_4 = new JTextField("");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Edit_fournisseur frame = new Edit_fournisseur();
	...
	public Edit_fournisseur() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					PreparedStatement ps = cnx.prepareStatement("update fournisseur set numf=?,num_contract=?,adr=?,tel=?,nomf=? where numf=?");
		...
		JLabel lblNewLabel_1 = new JLabel("Modifier fournisseur");
